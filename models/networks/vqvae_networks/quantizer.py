...
class VectorQuantizer(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            beta: _description_
            remap: _description_. Defaults to None.
            unknown_index: _description_. Defaults to "random".
            sane_index_shape: _description_. Defaults to False.
            legacy: _description_. Defaults to True.
        """
        super().__init__()
        self.n_e = n_e
        self.e_dim = e_dim
    ...
    def forward(self, z, temp=None, rescale_logits=False, return_logits=False, is_voxel=False):
        ...
        # distances from z to embeddings e_j (z - e)^2 = z^2 + e^2 - 2ez
        ...
        d = (
            ...
            - 2
            * torch.einsum(
                "bn, dn->bn", z_flattened, rearrange(self.embedding.weight, "n d -> d n")
            )
        )
